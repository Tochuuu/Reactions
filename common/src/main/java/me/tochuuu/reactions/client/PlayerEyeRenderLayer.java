...
public final class PlayerEyeRenderLayer extends RenderLayer<PlayerRenderState, PlayerModel> {
    ...
    private static final float PUPIL_FACE_Z = -4.021F / 16.0F;
    private static final float EYEBROW_FACE_Z = -4.023F / 16.0F;
    ...
    private static final int EATING_STOP_MOTION_STEP_TICKS = 3;
    private static final float[][] EATING_STOP_MOTION_FRAMES = {
        {1.35F, 1.00F},
        {1.75F, 1.45F},
        {1.60F, 1.25F},
        {1.45F, 1.05F}
    ...
    public void render(PoseStack poseStack, MultiBufferSource bufferSource, int light, PlayerRenderState state, float limbSwing, float limbSwingAmount) {
        ...
        if (!isSelf && remoteConfig == null && !useDefaultOfflineEyes && (playerOverride == null || !playerOverride.enabled)) {
            if (config.showMouth) {
                renderMouthOnly(poseStack, bufferSource, light, state, renderType(texture), config.animateOthers && config.animateMouth, EyeSettings.local(config));
            }
            return;
        }
        ...
        ReactionsClient.ManualEyeControl manualEyeControl = isSelf
        ...
        if (eyes.eyebrowsEnabled) {
            submitEyebrowAboveEye(poseStack, bufferSource, renderType, light, overlay, eyes.leftEyeX, eyes.leftEyeY, eyes.eyeWidth, eyes.leftEyeSkinLayer, eyebrowVerticalOffset(leftEye, eyes.eyeWidth, eyes.eyeHeight, hurtSclera));
            submitEyebrowAboveEye(poseStack, bufferSource, renderType, light, overlay, eyes.rightEyeX, eyes.rightEyeY, eyes.eyeWidth, eyes.rightEyeSkinLayer, eyebrowVerticalOffset(rightEye, eyes.eyeWidth, eyes.eyeHeight, hurtSclera));
        }
        if (!eyes.disabledEye.disablesLeftEye()) {
            submitLayeredEye(poseStack, bufferSource, renderType, light, overlay, eyes.leftEyeX, eyes.leftEyeY, eyes.eyelidColorX, eyes.eyelidColorY, eyes.eyeWidth, eyes.eyeHeight, eyes.leftEyeSkinLayer, eyes.eyelidColorSkinLayer, leftEye, eyeLook, EyeSide.LEFT, hurtSclera, fallingSurprise, eyelidColor, eyelidStyle.texturedEyelids);
        }
        if (!eyes.disabledEye.disablesRightEye()) {
            submitLayeredEye(poseStack, bufferSource, renderType, light, overlay, eyes.rightEyeX, eyes.rightEyeY, eyes.eyelidColorX, eyes.eyelidColorY, eyes.eyeWidth, eyes.eyeHeight, eyes.rightEyeSkinLayer, eyes.eyelidColorSkinLayer, rightEye, eyeLook, EyeSide.RIGHT, hurtSclera, fallingSurprise, eyelidColor, eyelidStyle.texturedEyelids);
        }
    ...
    private static void submitLayeredEye(PoseStack poseStack, MultiBufferSource bufferSource, RenderType renderType, int light, int overlay, int skinX, int skinY, int eyelidColorX, int eyelidColorY, int eyeWidth, int eyeHeight, ReactionsClientConfig.EyeSkinLayer eyeSkinLayer, ReactionsClientConfig.EyeSkinLayer eyelidColorSkinLayer, EyeExpression expression, int eyeLook, EyeSide side, boolean hurtSclera, boolean fallingSurprise, int eyelidColor, boolean texturedEyelids) {
        if (eyeSkinLayer == ReactionsClientConfig.EyeSkinLayer.OUTER) {
            ...
            if (expression == EyeExpression.CLOSED) {
                submitEye(poseStack, bufferSource, renderType, light, overlay, skinX, skinY, eyelidColorX, eyelidColorY, eyeWidth, eyeHeight, eyeSkinLayer, eyelidColorSkinLayer, expression, eyeLook, side, hurtSclera, fallingSurprise, eyelidColor, texturedEyelids);
                poseStack.popPose();
                return;
            }

            submitEye(poseStack, bufferSource, renderType, light, overlay, skinX, skinY, eyelidColorX, eyelidColorY, eyeWidth, eyeHeight, ReactionsClientConfig.EyeSkinLayer.BASE, eyelidColorSkinLayer, expression, eyeLook, side, hurtSclera, fallingSurprise, eyelidColor, texturedEyelids);
    ...
    private static void submitEye(PoseStack poseStack, MultiBufferSource bufferSource, RenderType renderType, int light, int overlay, int skinX, int skinY, int eyelidColorX, int eyelidColorY, int eyeWidth, int eyeHeight, ReactionsClientConfig.EyeSkinLayer eyeSkinLayer, ReactionsClientConfig.EyeSkinLayer eyelidColorSkinLayer, EyeExpression expression, int eyeLook, EyeSide side, boolean hurtSclera, boolean fallingSurprise, int eyelidColor, boolean texturedEyelids) {
        ...
        if (expression == EyeExpression.CLOSED) {
            submitEyelidTexture(poseStack, bufferSource, renderType, light, overlay, eyelidColorX, eyelidColorY, eyelidColorSkinLayer, eyeWidth, eyeHeight, dstX1, dstY1, dstX2, dstY2, eyelidColor, texturedEyelids);
            return;
        }

        if (expression == EyeExpression.OPEN && shouldExtendSclera(eyeWidth, eyeHeight, fallingSurprise)) {
            submitHurtScleraEye(poseStack, bufferSource, renderType, light, overlay, sourceSkinX, clampedSkinY, eyeWidth, eyeHeight, dstX1, dstY1, dstY2, side, true, shouldMirrorEyeColumns(eyeLook, side));
            return;
        }

        if (expression == EyeExpression.OPEN && canUseBlockEyeAnimation(eyeWidth, eyeHeight)) {
            submitBlockEye(poseStack, bufferSource, renderType, light, overlay, sourceSkinX, clampedSkinY, eyeWidth, eyeHeight, dstX1, dstY1, side, eyeLook, hurtSclera);
            return;
        }

        if (expression == EyeExpression.SQUINT) {
            submitSquintEye(poseStack, bufferSource, renderType, light, overlay, sourceSkinX, clampedSkinY, eyelidColorX, eyelidColorY, eyelidColorSkinLayer, eyeWidth, eyeHeight, dstX1, dstY1, dstY2, eyeLook, side, eyelidColor, texturedEyelids);
            return;
        }

        if (expression == EyeExpression.OPEN && shouldExtendSclera(eyeWidth, eyeHeight, hurtSclera)) {
            submitHurtScleraEye(poseStack, bufferSource, renderType, light, overlay, sourceSkinX, clampedSkinY, eyeWidth, eyeHeight, dstX1, dstY1, dstY2, side, false, false);
            return;
        }
        ...
        quad(bufferSource.getBuffer(renderType), poseStack.last(), dstX1, dstY1, dstX2, dstY2, u1, v1, u2, v2, light, overlay, NORMAL_COLOR);
    }

    private static void submitEyebrowAboveEye(PoseStack poseStack, MultiBufferSource bufferSource, RenderType renderType, int light, int overlay, int skinX, int skinY, int eyebrowWidth, ReactionsClientConfig.EyeSkinLayer eyeSkinLayer, float dstYOffset) {
        int clampedWidth = ReactionsClientConfig.clampEyeWidth(eyebrowWidth);
        int baseSkinX = clamp(skinX, (int) HEAD_FRONT_U, (int) (HEAD_FRONT_U + 8.0F) - clampedWidth);
        int sourceX = ReactionsClientConfig.eyeSourceX(baseSkinX, eyeSkinLayer);
        int sourceY = clamp(skinY - 1, (int) HEAD_FRONT_V, (int) (HEAD_FRONT_V + 7.0F));
        float dstX1 = baseSkinX - HEAD_FRONT_U - 4.0F;
        float dstY1 = sourceY - HEAD_FRONT_V - 8.0F + dstYOffset;
        float dstX2 = dstX1 + clampedWidth;
        float dstY2 = dstY1 + 1.0F;
        float insetX = Math.min(EYE_UV_INSET, clampedWidth * 0.25F);
        float insetY = Math.min(EYE_UV_INSET, 0.25F);
        float u1 = (sourceX + insetX) / SKIN_SIZE;
        float v1 = (sourceY + insetY) / SKIN_SIZE;
        float u2 = (sourceX + clampedWidth - insetX) / SKIN_SIZE;
        float v2 = (sourceY + 1.0F - insetY) / SKIN_SIZE;
        eyebrowQuad(bufferSource.getBuffer(renderType), poseStack.last(), dstX1, dstY1, dstX2, dstY2, u1, v1, u2, v2, light, overlay, NORMAL_COLOR);
    }

    private static float eyebrowVerticalOffset(EyeExpression expression, int eyeWidth, int eyeHeight, boolean hurtSclera) {
        if (expression != EyeExpression.OPEN || !hurtSclera) {
            return 0.0F;
        }
        boolean eyeExtendsUp = canUseBlockEyeAnimation(eyeWidth, eyeHeight) || shouldExtendSclera(eyeWidth, eyeHeight, true);
    ...
    private static void eyebrowQuad(VertexConsumer consumer, PoseStack.Pose pose, float x1, float y1, float x2, float y2, float u1, float v1, float u2, float v2, int light, int overlay, int color) {
        eyebrowVertex(consumer, pose, x1, y2, u1, v2, light, overlay, color);
        eyebrowVertex(consumer, pose, x2, y2, u2, v2, light, overlay, color);
        eyebrowVertex(consumer, pose, x2, y1, u2, v1, light, overlay, color);
        eyebrowVertex(consumer, pose, x1, y1, u1, v1, light, overlay, color);
    }

    private static void eyebrowVertex(VertexConsumer consumer, PoseStack.Pose pose, float x, float y, float u, float v, int light, int overlay, int color) {
        consumer.addVertex(pose, x / 16.0F, y / 16.0F, EYEBROW_FACE_Z)
            .setColor(color)
            .setUv(u, v)
            .setOverlay(overlay)
            .setLight(light)
    ...
    private static void submitMouth(PoseStack poseStack, MultiBufferSource bufferSource, RenderType renderType, int light, int overlay, EyeSettings eyes) {
        ...
        submitMouthPixel(poseStack, bufferSource, renderType, light, overlay, eyes.leftMouthX, eyes.leftMouthY, eyes.mouthSkinLayer, dstX1, dstY1, dstX1 + 1.0F, dstY1 + 1.0F);
        submitMouthPixel(poseStack, bufferSource, renderType, light, overlay, eyes.rightMouthX, eyes.rightMouthY, eyes.mouthSkinLayer, dstX1 + 1.0F, dstY1, dstX1 + 2.0F, dstY1 + 1.0F);
    }
    ...
    private static void submitAdvancementMouth(PoseStack poseStack, MultiBufferSource bufferSource, RenderType renderType, int light, int overlay, EyeSettings eyes) {
        ...
        submitMouthPixel(poseStack, bufferSource, renderType, light, overlay, eyes.leftMouthX, eyes.leftMouthY, eyes.mouthSkinLayer, 1.25F, dstX1, dstY1, splitX, dstY1 + height + ADVANCEMENT_MOUTH_TOP_EXTENSION);
        submitMouthPixel(poseStack, bufferSource, renderType, light, overlay, eyes.rightMouthX, eyes.rightMouthY, eyes.mouthSkinLayer, 1.25F, splitX, dstY1, dstX1 + width, dstY1 + height + ADVANCEMENT_MOUTH_TOP_EXTENSION);
    }
    ...
    private static void submitUseMouth(PoseStack poseStack, MultiBufferSource bufferSource, RenderType renderType, int light, int overlay, EyeSettings eyes, PlayerActionAnimationState.MouthUseAnimation animation, float ageInTicks, int entityId) {
        ...
        if (animation == PlayerActionAnimationState.MouthUseAnimation.EATING) {
            int frame = Math.floorMod((int) offsetTicks / EATING_STOP_MOTION_STEP_TICKS, EATING_STOP_MOTION_FRAMES.length);
        ...
        float splitX = dstX1 + width * 0.5F;
        submitMouthPixel(poseStack, bufferSource, renderType, light, overlay, eyes.leftMouthX, eyes.leftMouthY, eyes.mouthSkinLayer, 1.0F, dstX1, dstY1, splitX, dstY1 + height);
        submitMouthPixel(poseStack, bufferSource, renderType, light, overlay, eyes.rightMouthX, eyes.rightMouthY, eyes.mouthSkinLayer, 1.0F, splitX, dstY1, dstX1 + width, dstY1 + height);
    }
    ...
    private static void submitMouthPixel(PoseStack poseStack, MultiBufferSource bufferSource, RenderType renderType, int light, int overlay, int skinX, int skinY, ReactionsClientConfig.EyeSkinLayer skinLayer, float dstX1, float dstY1, float dstX2, float dstY2) {
        submitMouthPixel(poseStack, bufferSource, renderType, light, overlay, skinX, skinY, skinLayer, 1.0F, dstX1, dstY1, dstX2, dstY2);
    }

    private static void submitMouthPixel(PoseStack poseStack, MultiBufferSource bufferSource, RenderType renderType, int light, int overlay, int skinX, int skinY, ReactionsClientConfig.EyeSkinLayer skinLayer, float sourceHeight, float dstX1, float dstY1, float dstX2, float dstY2) {
    ...
    private static void submitBlockEye(PoseStack poseStack, MultiBufferSource bufferSource, RenderType renderType, int light, int overlay, int skinX, int skinY, int eyeWidth, int eyeHeight, float dstX1, float dstY1, EyeSide side, int eyeLook, boolean hurtSclera) {
        ...
        if (hurtSclera) {
            ...
            submitEyePiece(poseStack, bufferSource, renderType, light, overlay, skinX + externalColumn, skinY, 1.0F, eyeHeight, dstX1, eyeDstY1 - HURT_SCLERA_EXTENSION, dstX1 + eyeWidth, eyeDstY1, NORMAL_COLOR);
        }

        submitBlockEyeRow(poseStack, bufferSource, renderType, light, overlay, skinX, skinY, eyeWidth, eyeHeight, eyeHeight, dstX1, eyeDstY1, eyeDstY2, side, eyeLook);
    }

    private static void submitBlockEyeRow(PoseStack poseStack, MultiBufferSource bufferSource, RenderType renderType, int light, int overlay, int skinX, float sourceY, int eyeWidth, int eyeHeight, float sourceHeight, float dstX1, float dstY1, float dstY2, EyeSide side, int eyeLook) {
        ...
        if (eyeLook == DIRECT_BLOCK_FOCUS_UP_SIGNAL || eyeLook == DIRECT_BLOCK_FOCUS_DOWN_SIGNAL) {
            ...
            submitPupilPiece(poseStack, bufferSource, renderType, light, overlay, skinX + pupilSourceColumn, pupilSourceY, pupilWidth, visibleSourceHeight, dstX1 + pupilColumn, pupilDstY1, dstX1 + pupilColumn + pupilWidth, pupilDstY2, NORMAL_COLOR);
            return;
        }

        submitPupilPiece(poseStack, bufferSource, renderType, light, overlay, skinX + pupilSourceColumn, sourceY, pupilWidth, sourceHeight, dstX1 + pupilColumn, dstY1, dstX1 + pupilColumn + pupilWidth, dstY2, NORMAL_COLOR);
    }
    ...
    private static void submitPupilPiece(PoseStack poseStack, MultiBufferSource bufferSource, RenderType renderType, int light, int overlay, float sourceX, float sourceY, float sourceWidth, float sourceHeight, float dstX1, float dstY1, float dstX2, float dstY2, int color) {
        float insetX = Math.min(EYE_UV_INSET, sourceWidth * 0.25F);
        float insetY = Math.min(EYE_UV_INSET, sourceHeight * 0.25F);
        float u1 = (sourceX + insetX) / SKIN_SIZE;
        float v1 = (sourceY + insetY) / SKIN_SIZE;
        float u2 = (sourceX + sourceWidth - insetX) / SKIN_SIZE;
        float v2 = (sourceY + sourceHeight - insetY) / SKIN_SIZE;
        pupilQuad(bufferSource.getBuffer(renderType), poseStack.last(), dstX1, dstY1, dstX2, dstY2, u1, v1, u2, v2, light, overlay, color);
    }

    private static void submitEyelidTexture(PoseStack poseStack, MultiBufferSource bufferSource, RenderType renderType, int light, int overlay, int eyelidX, int eyelidY, ReactionsClientConfig.EyeSkinLayer eyelidSkinLayer, int tileColumns, int tileRows, float dstX1, float dstY1, float dstX2, float dstY2, int color, boolean texturedEyelids) {
        ...
        if (rows == 1) {
            submitStretchedEyelidPixel(poseStack, bufferSource, renderType, light, overlay, sourceX, sourceY, dstX1, dstY1, dstX2, dstY2, color);
            return;
        }
        ...
        for (int row = 0; row < rows; row++) {
            ...
            for (int column = 0; column < columns; column++) {
                int tileColor = eyelidTileColor(color, row, rows, column, columns, texturedEyelids);
                float tileDstX1 = dstX1 + column * tileWidth;
                float tileDstX2 = column == columns - 1 ? dstX2 : tileDstX1 + tileWidth;
                submitEyePiece(poseStack, bufferSource, renderType, light, overlay, sourceX, sourceY, 1.0F, 1.0F, tileDstX1, tileDstY1, tileDstX2, tileDstY2, tileColor);
            }
        }
    }

    private static void submitStretchedEyelidPixel(PoseStack poseStack, MultiBufferSource bufferSource, RenderType renderType, int light, int overlay, int sourceX, int sourceY, float dstX1, float dstY1, float dstX2, float dstY2, int color) {
        float u1 = sourceX / SKIN_SIZE;
        float v1 = sourceY / SKIN_SIZE;
        float u2 = (sourceX + 1) / SKIN_SIZE;
    ...
    private static int eyelidColor(boolean cleanEyelidColor, int tintIntensity, int eyeHeight) {
        if (cleanEyelidColor) {
            return NORMAL_COLOR;
        }
        int targetColor = eyeHeight > 1 ? LARGE_EYELID_DARKEN_COLOR : EYELID_DARKEN_COLOR;
        float intensity = clamp(tintIntensity, 0, 100) / 100.0F;
        int red = Math.round(255 + (((targetColor >>> 16) & 0xFF) - 255) * intensity);
        int green = Math.round(255 + (((targetColor >>> 8) & 0xFF) - 255) * intensity);
        int blue = Math.round(255 + ((targetColor & 0xFF) - 255) * intensity);
        return 0xFF000000 | red << 16 | green << 8 | blue;
    }

    private static int eyelidTileColor(int color, int row, int rows, int column, int columns, boolean texturedEyelids) {
        if (color == NORMAL_COLOR || !texturedEyelids) {
            return color;
        }
    ...
    private static int pupilDestinationColumn(EyeSide side, int eyeLook, int eyeWidth, int eyeHeight, int pupilWidth) {
        if (eyeLook == -1) {
            return 0;
        }
        if (eyeLook == 1) {
    ...
    private static void submitSquintEye(PoseStack poseStack, MultiBufferSource bufferSource, RenderType renderType, int light, int overlay, int skinX, int skinY, int eyelidX, int eyelidY, ReactionsClientConfig.EyeSkinLayer eyelidSkinLayer, int eyeWidth, int eyeHeight, float dstX1, float dstY1, float dstY2, int eyeLook, EyeSide side, int eyelidColor, boolean texturedEyelids) {
        ...
        submitEyelidTexture(poseStack, bufferSource, renderType, light, overlay, eyelidX, eyelidY, eyelidSkinLayer, eyeWidth, eyelidSourceHeight, dstX1, dstY1, dstX2, splitY, eyelidColor, texturedEyelids);
        ...
        if (canUseBlockEyeAnimation(eyeWidth, eyeHeight)) {
            submitBlockEyeRow(poseStack, bufferSource, renderType, light, overlay, skinX, sourceY1, eyeWidth, eyeHeight, sourceVisibleHeight, dstX1, splitY, dstY2, side, eyeLook);
            return;
        }
    ...
    private static void submitHurtScleraEye(PoseStack poseStack, MultiBufferSource bufferSource, RenderType renderType, int light, int overlay, int skinX, int skinY, int eyeWidth, int eyeHeight, float dstX1, float dstY1, float dstY2, EyeSide side, boolean surprise, boolean mirrored) {
        ...
        if (surprise && eyeWidth == 2 && eyeHeight == 2) {
            submitEyePiece(poseStack, bufferSource, renderType, light, overlay, externalSourceX, skinY, 1.0F, 1.0F, dstX1, extendedDstY1, dstX1 + eyeWidth, dstY1, NORMAL_COLOR);
            return;
        }
        ...
        for (int column = 0; column < eyeWidth; column++) {
            ...
            quad(bufferSource.getBuffer(renderType), poseStack.last(), finalDstX1, overlayDstY1, finalDstX2, dstY2, u1, v1, u2, v2, light, overlay, NORMAL_COLOR);
        }
    }
    ...
    private static EyeSide manualOneEyeSide(int eyeLook) {
        if (eyeLook < 0 && eyeLook != DIRECT_BLOCK_FOCUS_UP_SIGNAL) {
            return EyeSide.LEFT;
        }
        if (eyeLook > 0 && eyeLook != DIRECT_BLOCK_FOCUS_DOWN_SIGNAL) {

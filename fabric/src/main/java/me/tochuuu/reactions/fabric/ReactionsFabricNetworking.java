...
public class ReactionsFabricNetworking implements ReactionsNetworking.Platform {
    ...
    public static void init() {
        ...
        PayloadTypeRegistry.playC2S().register(ReactionsNetworking.ManualEyeC2SPayload.TYPE, ReactionsNetworking.ManualEyeC2SPayload.STREAM_CODEC);
        PayloadTypeRegistry.playS2C().register(ReactionsNetworking.ManualEyeS2CPayload.TYPE, ReactionsNetworking.ManualEyeS2CPayload.STREAM_CODEC);

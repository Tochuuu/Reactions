...
public final class PlayerEyeRenderLayer extends RenderLayer {
    ...
    private static void submitBlockEye(PoseStack poseStack, VertexConsumer consumer, int light, int overlay, int skinX, int skinY, int eyeWidth, int eyeHeight, float dstX1, float dstY1, EyeSide side, int eyeLook, boolean hurtSclera) {
        ...
        submitBlockEyeRow(poseStack, consumer, light, overlay, skinX, skinY, eyeWidth, eyeHeight, dstX1, eyeDstY1, eyeDstY2, side, eyeLook);
    }

    private static void submitBlockEyeRow(PoseStack poseStack, VertexConsumer consumer, int light, int overlay, int skinX, float sourceY, int eyeWidth, float sourceHeight, float dstX1, float dstY1, float dstY2, EyeSide side, int eyeLook) {
    ...
    private static void submitSquintEye(PoseStack poseStack, VertexConsumer consumer, int light, int overlay, int skinX, int skinY, int eyelidX, int eyelidY, int eyeWidth, int eyeHeight, float dstX1, float dstY1, float dstY2, int eyeLook, EyeSide side, int eyelidColor) {
        ...
        if (canUseBlockEyeAnimation(eyeWidth, eyeHeight)) {
            submitBlockEyeRow(poseStack, consumer, light, overlay, skinX, sourceY1, eyeWidth, sourceVisibleHeight, dstX1, splitY, dstY2, side, eyeLook);
            return;
        }

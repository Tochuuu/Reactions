...
public final class PlayerEyeRenderLayer extends RenderLayer<AvatarRenderState, PlayerModel> {
    ...
    private static void submitBlockEyeRow(PoseStack poseStack, SubmitNodeCollector collector, RenderType renderType, int light, int overlay, int skinX, float sourceY, int eyeWidth, float sourceHeight, float dstX1, float dstY1, float dstY2, EyeSide side, int eyeLook) {

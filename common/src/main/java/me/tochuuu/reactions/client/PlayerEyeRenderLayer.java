...
public final class PlayerEyeRenderLayer extends RenderLayer<PlayerRenderState, PlayerModel> {
    ...
    public void render(PoseStack poseStack, MultiBufferSource bufferSource, int light, PlayerRenderState state, float limbSwing, float limbSwingAmount) {
        ...
        submitEye(poseStack, bufferSource, renderType, light, overlay, eyes.leftEyeX, eyes.leftEyeY, eyes.eyelidColorX, eyes.eyelidColorY, eyes.eyeWidth, eyes.eyeHeight, leftEye, mirroredEye == -1, idleEyeOffset, eyelidProgress, EyeSide.LEFT, hurtSclera, damageProgress);
        submitEye(poseStack, bufferSource, renderType, light, overlay, eyes.rightEyeX, eyes.rightEyeY, eyes.eyelidColorX, eyes.eyelidColorY, eyes.eyeWidth, eyes.eyeHeight, rightEye, mirroredEye == 1, idleEyeOffset, eyelidProgress, EyeSide.RIGHT, hurtSclera, damageProgress);
    ...
    private static void submitEye(PoseStack poseStack, MultiBufferSource bufferSource, RenderType renderType, int light, int overlay, int skinX, int skinY, int eyelidColorX, int eyelidColorY, int eyeWidth, int eyeHeight, EyeExpression expression, boolean mirrored, float eyeOffset, float eyelidProgress, EyeSide side, boolean hurtSclera, float scleraProgress) {
        ...
        if (expression == EyeExpression.OPEN && eyeWidth >= 2 && (eyeOffset != 0.0F || scleraProgress > 0.0F)) {
            submitSmoothOpenEye(poseStack, bufferSource, renderType, light, overlay, clampedSkinX, clampedSkinY, eyeWidth, eyeHeight, dstX1, dstY1, dstY2, side, eyeOffset, hurtSclera ? scleraProgress : 0.0F);
            return;
        }

        if (expression == EyeExpression.OPEN && shouldExtendSclera(eyeWidth, eyeHeight, hurtSclera)) {
            submitHurtScleraEye(poseStack, bufferSource, renderType, light, overlay, clampedSkinX, clampedSkinY, eyeWidth, eyeHeight, dstX1, dstY1, dstY2, side, mirrored, scleraProgress);
            return;
        }
    ...
    private static void submitSmoothOpenEye(PoseStack poseStack, MultiBufferSource bufferSource, RenderType renderType, int light, int overlay, int skinX, int skinY, int eyeWidth, int eyeHeight, float dstX1, float dstY1, float dstY2, EyeSide side, float eyeOffset, float scleraProgress) {
        ...
        quad(bufferSource.getBuffer(renderType), poseStack.last(), dstX1, extendedDstY1, dstX1 + eyeWidth, dstY2, scleraU1, scleraV1, scleraU2, scleraV2, light, overlay, NORMAL_COLOR);
        ...
        quad(bufferSource.getBuffer(renderType), poseStack.last(), pupilX, dstY1, pupilX + 1.0F, dstY2, pupilU1, pupilV1, pupilU2, pupilV2, light, overlay, NORMAL_COLOR);
    }
    ...
    private static void submitHurtScleraEye(PoseStack poseStack, MultiBufferSource bufferSource, RenderType renderType, int light, int overlay, int skinX, int skinY, int eyeWidth, int eyeHeight, float dstX1, float dstY1, float dstY2, EyeSide side, boolean mirrored, float scleraProgress) {
        float extendedDstY1 = dstY1 - HURT_SCLERA_EXTENSION * Math.max(0.0F, Math.min(1.0F, scleraProgress));
        int externalColumn = side == EyeSide.LEFT ? 0 : eyeWidth - 1;
    ...
    private static float smoothIdleEyeOffset(PlayerRenderState state, int movementPixels) {

...
public final class PlayerEyeRenderLayer extends RenderLayer {
    ...
    private static void submitAdvancementMouth(PoseStack poseStack, VertexConsumer consumer, int light, int overlay, EyeSettings eyes) {
        ...
        submitMouthPixel(poseStack, consumer, light, overlay, eyes.leftMouthX, eyes.leftMouthY, 1.25F, dstX1, dstY1, splitX, dstY1 + height);
        submitMouthPixel(poseStack, consumer, light, overlay, eyes.rightMouthX, eyes.rightMouthY, 1.25F, splitX, dstY1, dstX1 + width, dstY1 + height);
    }

...
public final class ReactionsConfigScreen extends Screen {
    ...
    public void extractRenderState(GuiGraphicsExtractor graphics, int mouseX, int mouseY, float partialTick) {
        ...
        graphics.text(this.font, Component.literal("Width: " + config.eyeWidth), panelX, eyeWidthRowY + rowTextOffset, 0xFFFFFFFF);
        graphics.text(this.font, Component.literal("Height: " + config.eyeHeight), panelX, eyeHeightRowY + rowTextOffset, 0xFFFFFFFF);

        if (sizeLimitMessageTicks > 0) {
            graphics.text(this.font, Component.literal("Eye size limit reached"), panelX, Math.min(this.height - 38, eyeHeightRowY + layoutButtonHeight + 4), 0xFFFF6060);
        }
    }

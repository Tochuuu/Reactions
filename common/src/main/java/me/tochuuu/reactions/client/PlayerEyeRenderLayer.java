...
public final class PlayerEyeRenderLayer extends RenderLayer<AvatarRenderState, PlayerModel> {
    ...
    public void submit(PoseStack poseStack, SubmitNodeCollector collector, int light, AvatarRenderState state, float limbSwing, float limbSwingAmount) {
        ...
        submitEye(poseStack, collector, renderType, light, eyeOverlay, eyes.leftEyeX, eyes.leftEyeY, eyes.eyelidColorX, eyes.eyelidColorY, eyes.eyeWidth, eyes.eyeHeight, leftEye, eyeLook, EyeSide.LEFT, hurtSclera, eyelidColor);
        submitEye(poseStack, collector, renderType, light, eyeOverlay, eyes.rightEyeX, eyes.rightEyeY, eyes.eyelidColorX, eyes.eyelidColorY, eyes.eyeWidth, eyes.eyeHeight, rightEye, eyeLook, EyeSide.RIGHT, hurtSclera, eyelidColor);
    ...
    private static void submitEye(PoseStack poseStack, SubmitNodeCollector collector, RenderType renderType, int light, int overlay, int skinX, int skinY, int eyelidColorX, int eyelidColorY, int eyeWidth, int eyeHeight, EyeExpression expression, int eyeLook, EyeSide side, boolean hurtSclera, int eyelidColor) {
        ...
        if (expression == EyeExpression.CLOSED) {
            submitEyelidTexture(poseStack, collector, renderType, light, overlay, eyelidColorX, eyelidColorY, eyeWidth, eyeHeight, dstX1, dstY1, dstX1 + eyeWidth, dstY2, eyelidColor);
            return;
        }
        ...
        if (expression == EyeExpression.OPEN && shouldExtendSclera(eyeWidth, eyeHeight, hurtSclera)) {
            submitHurtScleraEye(poseStack, collector, renderType, light, overlay, clampedSkinX, clampedSkinY, eyeWidth, eyeHeight, dstX1, dstY1, dstY2, side, mirrored);
            return;
        }
    ...
    private static void submitBlockEye(PoseStack poseStack, SubmitNodeCollector collector, RenderType renderType, int light, int overlay, int skinX, int skinY, int eyeWidth, int eyeHeight, float dstX1, float dstY1, EyeSide side, int eyeLook, boolean hurtSclera) {
        ...
        if (browHeight > 0) {
            submitEyePiece(poseStack, collector, renderType, light, overlay, skinX, skinY, eyeWidth, browHeight, dstX1, dstY1, dstX1 + eyeWidth, dstY1 + browHeight, NORMAL_COLOR);
        }
        ...
        if (hurtSclera) {
            ...
            submitEyePiece(poseStack, collector, renderType, light, overlay, skinX + externalColumn, eyeSourceY, 1.0F, eyeSourceHeight, dstX1, eyeDstY1 - HURT_SCLERA_EXTENSION, dstX1 + eyeWidth, eyeDstY1, NORMAL_COLOR);
        }

        submitBlockEyeRow(poseStack, collector, renderType, light, overlay, skinX, eyeSourceY, eyeSourceHeight, dstX1, eyeDstY1, eyeDstY2, side, eyeLook);
    }

    private static void submitBlockEyeRow(PoseStack poseStack, SubmitNodeCollector collector, RenderType renderType, int light, int overlay, int skinX, float sourceY, float sourceHeight, float dstX1, float dstY1, float dstY2, EyeSide side, int eyeLook) {
        ...
        submitEyePiece(poseStack, collector, renderType, light, overlay, skinX + pupilSourceColumn, sourceY, 1.0F, sourceHeight, dstX1 + pupilColumn, dstY1, dstX1 + pupilColumn + 1.0F, dstY2, NORMAL_COLOR);
    }
    ...
    private static void submitSquintEye(PoseStack poseStack, SubmitNodeCollector collector, RenderType renderType, int light, int overlay, int skinX, int skinY, int eyelidX, int eyelidY, int eyeWidth, int eyeHeight, float dstX1, float dstY1, float dstY2, int eyeLook, EyeSide side, int eyelidColor) {
        ...
        if (canUseBlockEyeAnimation(eyeWidth, eyeHeight)) {
            int browHeight = eyeHeight == 2 ? 1 : 0;
            submitBlockEyeRow(poseStack, collector, renderType, light, overlay, skinX, skinY + browHeight, eyeHeight - browHeight, dstX1, splitY, dstY2, side, eyeLook);
            return;
        }

...
public final class ReactionsEyelidOptionsScreen extends Screen {
    ...
    private void drawPreview(GuiGraphics graphics, Identifier texture, ReactionsClientConfig config, boolean closed) {
    ...
    private void drawClosedEye(GuiGraphics graphics, Identifier texture, int skinX, int skinY, ReactionsClientConfig config) {
    ...
    private void drawEyelidTile(GuiGraphics graphics, Identifier texture, int x, int y, int width, int height, int tintAlpha, ReactionsClientConfig config) {

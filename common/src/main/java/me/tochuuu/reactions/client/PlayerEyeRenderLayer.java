...
public final class PlayerEyeRenderLayer extends RenderLayer {
    ...
    public void render(PoseStack poseStack, MultiBufferSource bufferSource, int light, Entity entity, float limbSwing, float limbSwingAmount, float partialTick, float ageInTicks, float netHeadYaw, float headPitch) {
        ...
        submitEye(poseStack, consumer, light, overlay, eyes.leftEyeX, eyes.leftEyeY, eyes.eyelidColorX, eyes.eyelidColorY, eyes.eyeWidth, eyes.eyeHeight, leftEye, eyeLook, EyeSide.LEFT, hurtSclera, eyelidColor, config.texturedEyelids);
        submitEye(poseStack, consumer, light, overlay, eyes.rightEyeX, eyes.rightEyeY, eyes.eyelidColorX, eyes.eyelidColorY, eyes.eyeWidth, eyes.eyeHeight, rightEye, eyeLook, EyeSide.RIGHT, hurtSclera, eyelidColor, config.texturedEyelids);
    ...
    private static void submitEye(PoseStack poseStack, VertexConsumer consumer, int light, int overlay, int skinX, int skinY, int eyelidColorX, int eyelidColorY, int eyeWidth, int eyeHeight, EyeExpression expression, int eyeLook, EyeSide side, boolean hurtSclera, int eyelidColor, boolean texturedEyelids) {
        ...
        if (expression == EyeExpression.CLOSED) {
            submitEyelidTexture(poseStack, consumer, light, overlay, eyelidColorX, eyelidColorY, eyeWidth, eyeHeight, dstX1, dstY1, dstX1 + eyeWidth, dstY2, eyelidColor, texturedEyelids);
            return;
        }
    ...
    private static void submitHurtScleraEye(PoseStack poseStack, VertexConsumer consumer, int light, int overlay, int skinX, int skinY, int eyeWidth, int eyeHeight, float dstX1, float dstY1, float dstY2, EyeSide side, boolean mirrored) {
        ...
        if (eyeWidth == 2 && eyeHeight == 2) {
            submitColumnScleraExtension(poseStack, consumer, light, overlay, skinX, skinY, eyeWidth, dstX1, extendedDstY1, dstY1, mirrored);
        } else {
    ...
    private static void submitColumnScleraExtension(PoseStack poseStack, VertexConsumer consumer, int light, int overlay, int skinX, int skinY, int eyeWidth, float dstX1, float extendedDstY1, float dstY1, boolean mirrored) {
        for (int column = 0; column < eyeWidth; column++) {
            int sourceX = mirrored ? skinX + eyeWidth - 1 - column : skinX + column;
            float columnDstX1 = dstX1 + column;
            float columnDstX2 = columnDstX1 + 1.0F;
            ...
            quad(consumer, poseStack.last(), columnDstX1, extendedDstY1, columnDstX2, dstY1, u1, v1, u2, v2, light, overlay, NORMAL_COLOR);
        }
    }

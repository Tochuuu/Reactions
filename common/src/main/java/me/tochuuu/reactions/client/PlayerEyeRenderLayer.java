...
public final class PlayerEyeRenderLayer extends RenderLayer<PlayerRenderState, PlayerModel> {
    ...
    public void render(PoseStack poseStack, MultiBufferSource bufferSource, int light, PlayerRenderState state, float limbSwing, float limbSwingAmount) {
        ...
        submitEye(poseStack, bufferSource, renderType, light, overlay, eyes.leftEyeX, eyes.leftEyeY, eyes.eyelidColorX, eyes.eyelidColorY, eyes.eyeWidth, eyes.eyeHeight, leftEye, eyeLook, EyeSide.LEFT, hurtSclera, eyelidColor);
        submitEye(poseStack, bufferSource, renderType, light, overlay, eyes.rightEyeX, eyes.rightEyeY, eyes.eyelidColorX, eyes.eyelidColorY, eyes.eyeWidth, eyes.eyeHeight, rightEye, eyeLook, EyeSide.RIGHT, hurtSclera, eyelidColor);
    ...
    private static void submitEye(PoseStack poseStack, MultiBufferSource bufferSource, RenderType renderType, int light, int overlay, int skinX, int skinY, int eyelidColorX, int eyelidColorY, int eyeWidth, int eyeHeight, EyeExpression expression, int eyeLook, EyeSide side, boolean hurtSclera, int eyelidColor) {
        ...
        if (expression == EyeExpression.CLOSED) {
            submitEyelidTexture(poseStack, bufferSource, renderType, light, overlay, eyelidColorX, eyelidColorY, eyeWidth, eyeHeight, dstX1, dstY1, dstX1 + eyeWidth, dstY2, eyelidColor);
            return;
        }
    ...
    private static void submitEyelidTexture(PoseStack poseStack, MultiBufferSource bufferSource, RenderType renderType, int light, int overlay, int eyelidX, int eyelidY, int tileColumns, int tileRows, float dstX1, float dstY1, float dstX2, float dstY2, int color) {
    ...
    private static void submitSquintEye(PoseStack poseStack, MultiBufferSource bufferSource, RenderType renderType, int light, int overlay, int skinX, int skinY, int eyelidX, int eyelidY, int eyeWidth, int eyeHeight, float dstX1, float dstY1, float dstY2, int eyeLook, EyeSide side, int eyelidColor) {
        ...
        submitEyelidTexture(poseStack, bufferSource, renderType, light, overlay, eyelidX, eyelidY, eyeWidth, eyelidSourceHeight, dstX1, dstY1, dstX2, splitY, eyelidColor);
